...
const Leaderboard = () => {
    // Timer simulation
    const [seconds, setSeconds] = useState(5535); // 1h 32m 15s
    ...
    useEffect(() => {
        ...
        }, 5000); // Update roughly every 5 seconds for visual effect
    ...
    return (
        <div className="leaderboard-page-body">
            <header className="leaderboard-header">
                <a href="#" className="back-btn" onClick={(e) => { e.preventDefault(); window.history.back(); }}>← 대회 홈으로</a>
                <div className="leaderboard-timer">{formatTime(seconds)}</div>
            ...
            <div className="leaderboard-container">
                <div className="title-section">
                    ...
                    <div style={{fontSize: '0.9rem', color: '#718096'}}>
                        Last updated: <span id="update-time">{currentTime}</span>
                    </div>
                </div>
