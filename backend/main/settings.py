...
# Media files (uploaded files like editorial PDFs)
MEDIA_URL = '/media/'
...
CELERY_BEAT_SCHEDULE = {
    'update-active-contests-every-60-seconds': {
        'task': 'contest.tasks.update_active_contests_task',
        'schedule': 60.0,
    },
}
